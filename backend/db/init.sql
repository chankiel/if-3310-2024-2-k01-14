...
CREATE TABLE "room_chat" (
  ...
  PRIMARY KEY (id),
  CONSTRAINT room_chat_first_user_fk FOREIGN KEY (first_user_id) REFERENCES users (id) ON DELETE CASCADE,
  CONSTRAINT room_chat_second_user_fk FOREIGN KEY (second_user_id) REFERENCES users (id) ON DELETE CASCADE,
  CONSTRAINT room_chat_last_sender_fk FOREIGN KEY (last_sender_id) REFERENCES users (id) ON DELETE SET NULL,
