    ...
    const profileData: ProfileData = {
        ...
        activities: [
            {
                name: "Francesco Michael Kusuma",
                time: "3w",
                description: "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Id eum quod reiciendis quos magni tempora qui laborum, natus perferendis maxime corporis molestiae nam ut, temporibus illo velit mollitia error consequuntur!",
            },
            {
                name: "John Doe",
                time: "1w",
        ...
        experiences: [
            ...
            },
            {
                ...
                description: "Worked on various projects, focusing on front-end development and user experience.",
            },
            {
                id: 4,
                jobTitle: "Software Engineer",
        ...
        skills: ["Communication", "Teamwork", "Problem Solving", "Adaptability", "Creativity", "Communication", "Teamwork", "Problem Solving", "Adaptability", "Creativity"],
        recommendations: [
            {
                id: 1,
                name: "Francesco Michael Kusuma",
            ...
            <div className="bg-custom-bg-color min-h-screen">
                <div className="flex flex-col md:flex-row p-12 justify-center gap-x-6">
                    ...
                    <div className="ml-2 max-w-3xl">
                        <ProfileSection profileData={profileData.user} skills={profileData.skills} experiences={profileData.experiences}/>
                    ...
                    <div className="max-w-xs">
                        <RecommendationSection recommendations={profileData.recommendations}/>
                    </div>
                </div>  
            </div>
        </>
