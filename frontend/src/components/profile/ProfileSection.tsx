                ...
                <div className="ml-4 h-12 pt-2 text-base pl-4 flex">
                    {currentId === user_id ? (
                        ...
                        <>
                            ...
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="rgb(10, 102, 194)" className="mr-1">
                        ...
                        <>
                            <button
                                className="rounded-2xl py-1 px-4 font-semibold flex items-center"
                                style={{ backgroundColor: 'rgb(10, 102, 194)' }}
                            >
